...
Tendremos un docker-compose.yml que permitira gestionar en un volumen para modificaciones de el codigo sin necesidad de volver a compilar la aplicacion.
